...
2. 再判断课程包装方式：
   ...
   - `专题高阶课程`：把并行、PD/EPD、HiCache、输出控制、执行优化等深水区主题拆开单讲
3. 再判断课程深度：
   - `标准版主课程`：默认 15 课
...
如果用户关心 OpenAI-compatible serving、agent、函数调用、推理模型或受约束解码，默认覆盖：
...
- 官方文档首页：`https://docs.sglang.io/`
- 官方仓库：`https://github.com/sgl-project/sglang`
- 官方 release/tag：`https://github.com/sgl-project/sglang/releases`
- `README.md`
- `python/sglang/lang/`
- `python/sglang/srt/`
- `python/sglang/srt/entrypoints/`
