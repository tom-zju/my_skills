...
如果用户要求“结合最新版本”“结合最新代码”“main 分支”“最近实现”，或明确指定某个版本号，例如 `v0.19.0`，必须在生成课程前重新核对：
...
- 本专题营接管基础并行维度深讲
- 分布式相关主题默认全部留在专题营；只有用户明确要求主课程也纳入分布式时，才额外设计主课程内的分布式基础课
...
- 如果用户要求 18 到 20 节，直接在 `15 节标准版主课程` 后追加合适的专题营（即模板二中的专题高阶课程），不单独引入额外的深度版模板
